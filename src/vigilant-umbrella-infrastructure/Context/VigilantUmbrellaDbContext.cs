...
public class VigilantUmbrellaDbContext(DbContextOptions<VigilantUmbrellaDbContext> options) : DbContext(options), IVigilantUmbrellaDbContext
{
    ...
    /// The resulting model may be cached and re-used for subsequent instances of your
    /// derived context.
    /// </summary>
    /// <param name="modelBuilder">The builder being used to construct the model for this context. Databases (and other extensions)
    /// typically define extension methods on this object that allow you to configure aspects of the model that are specific
